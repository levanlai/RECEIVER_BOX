...
// Biquad[7] preset list. Table ID: 0x8
const globalBiquad7Preset global_biquad7_presets[GLOBAL_BIQUAD7_PRESET_NB] = 
{
	// GlobalPresetA_DSP04-PCS02
	{ 0, 0, 14847, 1, 955, 81920, 64, 1, 955, 81932, 64, 1, 955, 81944, 64, 1, 955, 81956, 64, 1, 955, 81968, 64, 1, 955, 81980, 64, 1, 955, 81992, 64 }
};
...
const globalS_Reverb_EchoPreset global_s_reverb_echo_presets[GLOBAL_S_REVERB_ECHO_PRESET_NB] = 
{
	...
	{ 10, 8192, 8192, 1251, 8192, 8192, 8192, 8192, 8192, 4421, 0, 8192, 8192, 11468, 8192, 127, 8192, 127 },
	// GlobalPresetA_DSP04-PCS03
	{ 9, 8192, 8192, 2731, 2507, 8192, 8192, 0, 8192, 4421, 0, 8192, 8192, 8192, 8192, 0, 8192, 0 }
};
...
// MixN[4] preset list. Table ID: 0x9
const globalMixN4Preset global_mixn4_presets[GLOBAL_MIXN4_PRESET_NB] = 
{
	// GlobalPresetA_DSP04-PCS05
	{ 0, 0, 0, 0, 14847, 14847, 14847, 14463 }
};
// MixN[3] preset list. Table ID: 0xa
const globalMixN3Preset global_mixn3_presets[GLOBAL_MIXN3_PRESET_NB] = 
{
	// GlobalPresetA_DSP04-PCS08
...
const WORD_FAR_P global_preset_table_address[NUMBER_OF_PRESET_TABLE] = 
{
	...
	FARPTR((const WORD*)&global_s_reverb_echo_presets), FARPTR((const WORD*)&global_mixn2_presets), FARPTR((const WORD*)&global_feedback_canceller_presets), FARPTR((const WORD*)&global_biquad7_presets), 
	FARPTR((const WORD*)&global_mixn4_presets), FARPTR((const WORD*)&global_mixn3_presets)
};
...
// Biquad[7] preset control list.
const globalBiquad7Control global_biquad7_controls = 
{
	0x801f, 38, 0x0, 0x1, 0x4002, 0x3, 0x4022, 0x8041, 0x60, 0x4, 0x4023, 0x8042, 0x61, 0x5, 0x4024, 0x8043, 0x62, 0x6, 0x4025, 0x8044, 0x63, 0x7, 0x4026, 0x8045, 0x64, 0x8, 0x4027, 0x8046, 0x65, 0x9, 0x4028, 0x8047, 0x66
};
...
// MixN[4] preset control list.
const globalMixN4Control global_mixn4_controls = 
{
	8, 8, 0x0, 0x1, 0x2, 0x3, 0x401f, 0x4020, 0x4021, 0x4022
};
...
const WORD_FAR_P global_preset_control_table_address[NUMBER_OF_PRESET_TABLE] = 
{
	...
	FARPTR((const WORD*)&global_s_reverb_echo_controls), FARPTR((const WORD*)&global_mixn2_controls), FARPTR((const WORD*)&global_feedback_canceller_controls), FARPTR((const WORD*)&global_biquad7_controls), 
	FARPTR((const WORD*)&global_mixn4_controls), FARPTR((const WORD*)&global_mixn3_controls)
};
const DWORD globalpreset[1][35] = 
{
	// GlobalPresetA
	{ 
	// DSP#1
	0x1000a, 0x1, 0x100002, 0x200003, 0x300004, 0x400005, 0x500006, 0x600007, 0x600008, 0x600109, 0xa,
	// DSP#2
	0x2000a, 0x1, 0x100002, 0x200003, 0x300004, 0x400005, 0x500006, 0x600007, 0x600008, 0x600109, 0xa,
	// DSP#3
	0x30002, 0x700001, 0x2,
	// DSP#4
	0x40009, 0x600001, 0x800002, 0x500103, 0x600004, 0x900005, 0x600106, 0x600007, 0xb, 0xa00008 }
};
