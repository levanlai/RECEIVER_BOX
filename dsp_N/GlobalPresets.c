...
const globalS_Reverb_EchoPreset global_s_reverb_echo_presets[GLOBAL_S_REVERB_ECHO_PRESET_NB] = 
{
	...
	{ 12, 8192, 8192, 1251, 8192, 8192, 8192, 8192, 8192, 8192, 0, 8192, 8192, 8192, 8192, 127, 8192, 127 }
};
...
const WORD_FAR_P global_preset_table_address[NUMBER_OF_PRESET_TABLE] = 
{
	...
	FARPTR((const WORD*)&global_compressor_presets)
};
...
const WORD_FAR_P global_preset_control_table_address[NUMBER_OF_PRESET_TABLE] = 
{
	...
	FARPTR((const WORD*)&global_compressor_controls)
};
const DWORD globalpreset[1][31] = 
{
	// GlobalPresetA
	{ 
	// DSP#1
	...
	// DSP#4
	0x40009, 0x700001, 0x700002, 0x800003, 0x900004, 0x100005, 0x800006, 0x900007, 0x100008, 0x400009 }
};
